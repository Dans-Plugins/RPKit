...
class ListChatChannelsCommand(private val plugin: RPKChatBukkit) : CommandExecutor {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        // Every listeners query is started before any of them is awaited, so they still run
    ...
    private fun chatChannelComponents(
        chatChannel: RPKChatChannel,
        listeners: List<RPKMinecraftProfile>,
        ...
        messageComponents.add(textComponent)
        return messageComponents.toTypedArray()
    }
}
